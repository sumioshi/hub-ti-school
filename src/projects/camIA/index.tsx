    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-lg">
      ...
      <div className="mt-4">
        ...
        <input
          ...
          title="Selecione o horário de ativação"
          placeholder="HH:MM"
          aria-label="Horário de ativação"
        />
      </div>
      <div className="mt-6 flex justify-end">
        <button
    ...
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-60">
      <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-md">
        ...
        <input
          ...
          aria-label="Ajuste de sensibilidade"
        />
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            aria-label="Selecione data e hora"
          />
        </div>
...
const CamIASecurityDashboard: React.FC = () => {
  const [activeDashboard, setActiveDashboard] = useState('camia');
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex-1 p-6">
            <div className="flex flex-col lg:flex-row gap-6">
              {/* Sidebar */}
              <div className={`w-full lg:w-80 bg-gray-800 p-6 rounded-2xl shadow-lg ${!isSidebarOpen ? 'hidden' : ''}`}>
                <div className="p-4">
                  ...
                  <nav className="flex flex-col space-y-2">
                    <button className="text-left px-3 py-2 rounded hover:bg-gray-700 text-white" onClick={() => setActiveDashboard('camia')}>
                      Dashboard
                    </button>
                    <button className="text-left px-3 py-2 rounded hover:bg-gray-700 text-white" onClick={() => alert('Navegar para Alertas (simulado)')}>
                      Alertas
                    </button>
                    <button className="text-left px-3 py-2 rounded hover:bg-gray-700 text-white" onClick={() => alert('Navegar para Analytics (simulado)')}>
                      Analytics
                    </button>
                    <button className="text-left px-3 py-2 rounded hover:bg-gray-700 text-white" onClick={() => alert('Navegar para Configurações (simulado)')}>
                      Configurações
                    </button>
                  </nav>
                </div>
              ...
              <main className="flex-1">
                ...
                <div className="p-4 flex flex-col md:flex-row items-center justify-between">
                  <h1 className="text-3xl font-bold text-white mb-4 md:mb-0">{dashboardTitle}</h1>
                  <div className="flex flex-wrap gap-4">
                    <button
                      onClick={() => setActiveDashboard('camia')}
                      className={`px-4 py-2 rounded border ${activeDashboard === 'camia' ? 'bg-gradient-to-r from-blue-600 to-purple-600 text-white' : 'bg-gray-700 text-gray-300 hover:bg-gray-600'}`}
                    >
                      CamIASecurity 2.0
                    </button>
                    <button
                      onClick={() => setActiveDashboard('schoolguard')}
                      className={`px-4 py-2 rounded border ${activeDashboard === 'schoolguard' ? 'bg-gradient-to-r from-blue-600 to-purple-600 text-white' : 'bg-gray-700 text-gray-300 hover:bg-gray-600'}`}
                    >
                      SchoolGuardAI
                    </button>
                    <button
                      onClick={() => setViewMode(prev => (prev === 'single' ? 'grid' : 'single'))}
                      className="px-4 py-2 rounded border bg-gray-700 text-gray-300 hover:bg-gray-600"
                    >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 p-4">
                  ...
                  <div className="lg:col-span-3 space-y-4">
                    ...
                    <div className="bg-gray-800 rounded-xl shadow p-4">
                      <div className="flex items-center justify-between mb-4">
                        <h2 className="font-medium text-white">{cameraSectionTitle}</h2>
                        <button className="p-1.5 hover:bg-gray-700 rounded-lg" aria-label="Alternar visualização">
                      ...
                      <div className="space-y-2">
                        {currentCameras.map((cam) => (
                          ...
                          >
                            ...
                            {cam.alerts > 0 && (
                              <span className="px-2 py-1 bg-red-500/10 text-red-400 text-sm rounded-lg">
                                {cam.alerts}
                              </span>
                            )}
                          </button>
                        ...
                        {activeDashboard === 'camia' ? (
                          <>
                            <div className="p-4 bg-gray-700 rounded-lg">
                              ...
                              <p className="text-sm text-gray-300">Total de Pessoas</p>
                              <p className="text-xl font-bold text-white">{currentAnalytics.peopleCount}</p>
                            </div>
                            <div className="p-4 bg-gray-700 rounded-lg">
                              <Bell className="w-6 h-6 text-red-400 mb-2" />
                              <p className="text-sm text-gray-300">Alertas Ativos</p>
                              <p className="text-xl font-bold text-white">{currentAnalytics.activeAlerts}</p>
                            </div>
                            <div className="p-4 bg-gray-700 rounded-lg">
                              <Clock className="w-6 h-6 text-purple-400 mb-2" />
                              <p className="text-sm text-gray-300">Tempo Médio</p>
                              <p className="text-xl font-bold text-white">{currentAnalytics.avgDwellTime}</p>
                            </div>
                            <div className="p-4 bg-gray-700 rounded-lg">
                              <MapPin className="w-6 h-6 text-yellow-400 mb-2" />
                              <p className="text-sm text-gray-300">Zonas de Risco</p>
                              <p className="text-xl font-bold text-white">{currentAnalytics.riskZones}</p>
                            </div>
                          </>
                        ) : (
                          <>
                            <div className="p-4 bg-gray-700 rounded-lg">
                              <Users className="w-6 h-6 text-blue-400 mb-2" />
                              <p className="text-sm text-gray-300">Total de Alunos</p>
                              <p className="text-xl font-bold text-white">{currentAnalytics.studentsCount}</p>
                            </div>
                            <div className="p-4 bg-gray-700 rounded-lg">
                              <Bell className="w-6 h-6 text-red-400 mb-2" />
                              <p className="text-sm text-gray-300">Alertas Ativos</p>
                            ...
                            <div className="p-4 bg-gray-700 rounded-lg">
                              ...
                              <p className="text-xl font-bold text-white">{currentAnalytics.avgResponseTime}</p>
                            </div>
                            <div className="p-4 bg-gray-700 rounded-lg">
                              <MapPin className="w-6 h-6 text-yellow-400 mb-2" />
                              <p className="text-sm text-gray-300">Zonas de Risco</p>
                  ...
                  <div className="lg:col-span-6 space-y-4">
                    {viewMode === 'single' ? (
                      <div ref={videoContainerRef} className="bg-gray-800 rounded-xl shadow p-4">
                  ...
                  <div className="lg:col-span-3 space-y-4">
                          ...
                          >
                            <div className="flex items-start gap-3">
                              ...
                              <div className="flex-1">
                                ...
                                <p className="text-sm text-gray-300 mt-1">{alert.camera}</p>
                                <div className="flex items-center gap-2 mt-2">
                                  <span className="text-sm text-gray-400">Confiança: {alert.confidence}%</span>
                                  <button
                    ...
                    {/* Mapa de Calor */}
                    <div className="bg-gray-800 rounded-xl shadow p-4">
                      <h2 className="font-medium text-white mb-4">Mapa de Calor</h2>
                      <div className="aspect-square rounded-lg relative overflow-hidden bg-gradient-to-r from-blue-600 to-purple-600">
                ...
                <div className="p-4 bg-gray-800 rounded-xl shadow mt-6">
                  <h2 className="font-medium text-white mb-2">Ferramentas</h2>
                  <div className="flex flex-wrap gap-4">
                    <button onClick={() => setShowDetectionModal(true)} className="px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded hover:opacity-90">
                      Detecção
                    </button>
                    <button onClick={() => setShowCalibrationModal(true)} className="px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded hover:opacity-90">
                      Calibração
                    </button>
                    <button onClick={() => setShowAdvancedZonesModal(true)} className="px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded hover:opacity-90">
                      Zonas Avançadas
                    </button>
                    <button onClick={() => setShowAdvancedAnalyticsModal(true)} className="px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded hover:opacity-90">
                      Analytics Avançados
                    </button>
                    <button onClick={() => setShowAdvancedSearchModal(true)} className="px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded hover:opacity-90">
                      Busca Avançada
                    </button>
                    <button onClick={() => setShowAdvancedVisualizationModal(true)} className="px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded hover:opacity-90">
      ...
      {showAdvancedZonesModal && (
        <AdvancedZonesModal 
          onClose={() => setShowAdvancedZonesModal(false)} 
        />
      )}
      ...
      {showAdvancedVisualizationModal && (
        <AdvancedVisualizationModal 
          onClose={() => setShowAdvancedVisualizationModal(false)} 
        />
      )}
    </>
  );
